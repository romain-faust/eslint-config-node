...
> Shared [ESLint](https://eslint.org) configuration for Node.js.
...
-   [eslint-plugin-node](https://npmjs.org/package/eslint-plugin-node) >=11.1.0
...
Add `@romain-faust/eslint-config-node` to the [extends](https://eslint.org/docs/user-guide/configuring#extending-configuration-files) section of your [ESLint configuration](https://eslint.org/docs/user-guide/configuring):

```json
{
	"extends": "@romain-faust/eslint-config-node"
}
```
